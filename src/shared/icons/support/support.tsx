...
const SupportIconComponent: React.FC<Props> = ({ classes }) => {
  return (
    <SvgIcon width="24" height="24" viewBox="0 0 24 24" fill="none" className={classes.root}>
...
export const SupportIcon = withStyles(styles)(SupportIconComponent);